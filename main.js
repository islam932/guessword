...
document.querySelector("footer").innerHTML = `${gameName} Game - Created By Deimos The Chosen One`;
...
function handleGuesses() {
  ...
  if (successGuess) {
    ...
    if (numbersOfHints === 2) {
      messageArea.innerHTML = `<p>Congratulations! You Won AND You Didn't Use Hints!</p>The Word IS <span>${wordToGuess}</span>`;
    }
